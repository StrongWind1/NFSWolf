...
=== "Maximum security"
    ...
    [F-1.1](../../findings/identity/F-1.1-uid-gid-spoofing.md) (Kerberos replaces AUTH_SYS), [F-1.2](../../findings/identity/F-1.2-root-squash-bypass.md) (`all_squash` + Kerberos), [F-1.3](../../findings/identity/F-1.3-auxiliary-group-injection.md) (groups from KDC), [F-1.5](../../findings/identity/F-1.5-credential-replay.md) (replay protection), [F-1.6](../../findings/identity/F-1.6-nfsv2-downgrade.md) (v2/v3 disabled), [F-1.7](../../findings/identity/F-1.7-rpcsec-gss-flavor-downgrade.md) (no AUTH_SYS fallback), [F-2.1](../../findings/access-control/F-2.1-export-escape.md) (separate filesystems), [F-2.6](../../findings/access-control/F-2.6-bind-mount-escape.md) (no bind mounts), [F-3.1](../../findings/network/F-3.1-plaintext-wire-protocol.md) (krb5p encrypts wire), [F-4.1](../../findings/privesc/F-4.1-no-root-squash.md) (root_squash + read-only), [F-4.2](../../findings/privesc/F-4.2-suid-sgid-escalation.md) (read-only prevents upload), [F-5.1](../../findings/info-disclosure/F-5.1-export-list-enumeration.md) (no mountd for v4-only)
    ...
    !!! warning "What this does NOT protect against"
        ...
        - NFSv4 pseudo-filesystem traversal ([F-5.5](../../findings/info-disclosure/F-5.5-nfsv4-pseudo-fs-leakage.md)) may reveal export paths
        - Server-side logging of NFS operations remains limited ([F-7.6](../../findings/config/F-7.6-no-audit-logging.md))
...
=== "Practical security"
    ...
    [F-1.1](../../findings/identity/F-1.1-uid-gid-spoofing.md) (partial: Kerberos clients protected, AUTH_SYS clients not), [F-2.1](../../findings/access-control/F-2.1-export-escape.md) (separate filesystems), [F-4.1](../../findings/privesc/F-4.1-no-root-squash.md) (`root_squash`), [F-4.2](../../findings/privesc/F-4.2-suid-sgid-escalation.md) (builds/ISO read-only), [F-5.1](../../findings/info-disclosure/F-5.1-export-list-enumeration.md) (mountd firewalled), [F-7.1](../../findings/config/F-7.1-wildcard-export-policy.md) (subnet restrictions), [F-1.6](../../findings/identity/F-1.6-nfsv2-downgrade.md) (v2 disabled)

    ### Residual Risks

    !!! warning "What this does NOT protect against"
        - AUTH_SYS clients on the `192.168.10.0/24` subnet can spoof any non-root UID ([F-1.1](../../findings/identity/F-1.1-uid-gid-spoofing.md))
        ...
        - IP-based restrictions can be bypassed by an attacker who compromises a host on the authorized subnet or spoofs its IP ([F-3.3](../../findings/network/F-3.3-ip-spoofing-host-trust.md))
        - NFSv3 traffic without Kerberos is unencrypted ([F-3.1](../../findings/network/F-3.1-plaintext-wire-protocol.md))
...
=== "Minimum acceptable"
    ...
    !!! danger "Never use bind mounts as a substitute"
        `mount --bind /data/dev /srv/devdata` does NOT create filesystem isolation. Bind mounts share the parent filesystem's fsid, so the export escape attack works through them as if the bind mount did not exist ([F-2.6](../../findings/access-control/F-2.6-bind-mount-escape.md)).
    ...
    [F-2.1](../../findings/access-control/F-2.1-export-escape.md) (separate filesystems), [F-2.6](../../findings/access-control/F-2.6-bind-mount-escape.md) (no bind mounts), [F-4.1](../../findings/privesc/F-4.1-no-root-squash.md) (`root_squash`), [F-1.6](../../findings/identity/F-1.6-nfsv2-downgrade.md) (v2 disabled), [F-5.4](../../findings/info-disclosure/F-5.4-rpc-service-enumeration.md) (portmapper firewalled), [F-3.2](../../findings/network/F-3.2-portmapper-amplification.md) (amplification blocked), [F-7.1](../../findings/config/F-7.1-wildcard-export-policy.md) (subnet/host restrictions), [F-4.2](../../findings/privesc/F-4.2-suid-sgid-escalation.md) (packages/backups read-only; devdata still writable)

    ### Residual Risks

    !!! danger "Accepted risks without Kerberos"
        - **UID/GID spoofing is fully possible** ([F-1.1](../../findings/identity/F-1.1-uid-gid-spoofing.md)): any host on `10.0.5.0/24` can claim any non-root UID
        - **Auxiliary group injection** ([F-1.3](../../findings/identity/F-1.3-auxiliary-group-injection.md)): clients can claim membership in any group
        - **Wire sniffing** ([F-3.1](../../findings/network/F-3.1-plaintext-wire-protocol.md)): all data transmitted in cleartext
        - **IP spoofing** ([F-3.3](../../findings/network/F-3.3-ip-spoofing-host-trust.md)): export ACLs rely on source IP, which can be spoofed on the local network
        - **SUID upload on devdata** ([F-4.2](../../findings/privesc/F-4.2-suid-sgid-escalation.md)): writable export with `root_squash` still allows non-root SUID binaries
        - **No audit trail** ([F-7.6](../../findings/config/F-7.6-no-audit-logging.md)): NFS operations are not logged
