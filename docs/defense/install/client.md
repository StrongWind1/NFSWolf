...
| `nosuid` | No | Ignore setuid/setgid bits ([F-4.2](../../findings/privesc/F-4.2-suid-sgid-escalation.md)) |
| `nodev` | No | Ignore device nodes ([F-4.3](../../findings/privesc/F-4.3-device-node-creation.md)) |
...
!!! tip "Minimum security options for untrusted exports"
    ...
    This prevents three classes of privilege escalation via crafted files on the remote export. See [F-7.4](../../findings/config/F-7.4-missing-nosuid-nodev.md).
