...
The checklist below is ordered by impact. Completing the Critical tier eliminates the majority of the attack surface documented in the [findings catalog](../../index.md).

| Priority | Actions | Findings mitigated |
|----------|---------|-------------------|
| :material-alert-circle:{ .critical } **Critical** | Kerberos on all exports, no `no_root_squash`, separate filesystems per export, `all_squash` for public shares | [F-1.1](../../identity/F-1.1-uid-gid-spoofing.md), [F-1.2](../../identity/F-1.2-root-squash-bypass.md), [F-2.1](../../access-control/F-2.1-export-escape.md), [F-4.1](../../privesc/F-4.1-no-root-squash.md) |
| :material-alert:{ .high } **High** | Host/network restrictions, read-only where possible, fixed service ports, disable NFSv2/v3 | [F-1.6](../../identity/F-1.6-nfsv2-downgrade.md), [F-3.3](../../network/F-3.3-ip-spoofing-host-trust.md), [F-5.1](../../info-disclosure/F-5.1-export-list-enumeration.md), [F-7.2](../../config/F-7.2-privileged-port-bypass.md) |
| :material-alert-outline:{ .medium } **Medium** | `subtree_check`, portmapper restrictions, MOUNT DUMP monitoring, NFS over TLS | [F-2.6](../../access-control/F-2.6-bind-mount-escape.md), [F-3.1](../../network/F-3.1-plaintext-wire-protocol.md), [F-5.4](../../info-disclosure/F-5.4-rpc-service-enumeration.md) |
