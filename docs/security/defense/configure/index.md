...
This section covers the configuration layer. For what to actually set these options to, see [Hardening](../hardening/index.md). For why the defaults are dangerous, see the [Security](../../index.md) catalog.
