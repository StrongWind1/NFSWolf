...
For the full defense matrix and recommended configurations, see the [hardening checklist](hardening/checklist.md) and [example configurations](hardening/examples.md).
...
For defenses that actually work, see the [hardening checklist](hardening/checklist.md).
