...
This narrows the attack surface and guides further enumeration (e.g., Windows-specific handle signing per [F-2.3](../access-control/F-2.3-windows-handle-signing.md)).
