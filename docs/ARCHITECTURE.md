...
```
FINDINGS.md (55 findings with RFC-cited analysis, F-1.1 through F-7.7)
...
│   └── xdr_fuzz_test.rs
├── docs/
│   ├── FINDINGS.md                # Finding catalog (55 findings, F-1.1 through F-7.7)
│   ├── REQUIREMENTS.md            # Tool requirements (R1 through R7)
│   ├── DESIGN.md                  # Vision, goals, threat model
│   ├── ARCHITECTURE.md            # This file
│   ├── NFSv2.md, NFSv3.md, NFSv4.md  # Protocol reference notes
│   ├── findings/                  # Detailed finding write-ups (56 files: 55 findings + README)
│   └── research/
