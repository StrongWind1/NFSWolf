...
- Escape handles (see [F-2.1](F-2.1-export-escape.md)) target inodes on the same fsid
...
- UIDs/GIDs harvested for targeted spoofing (see [F-1.1](F-1.1-uid-gid-spoofing.md))
