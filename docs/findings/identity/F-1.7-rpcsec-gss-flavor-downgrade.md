...
| [F-3.1: Plaintext Wire Protocol](../network/F-3.1-plaintext-wire-protocol.md) | MITM prerequisite for active downgrade |
| [F-3.4: STRIPTLS Downgrade](../network/F-3.4-striptls-downgrade.md) | Transport-level downgrade; F-1.7 is auth-level downgrade |
