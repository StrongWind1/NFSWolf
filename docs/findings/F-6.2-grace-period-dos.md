...
Not implemented. Category 6 (denial of service) is out of scope for nfswolf
(see the status banner above); no subcommand detects grace-period behaviour or
the NFS4ERR_GRACE error. The check sketched in earlier drafts was never built.
