...
> **Status: out of scope for nfswolf.** The lock-DoS module that exercised
> this finding was removed, along with the NLM and NSM clients. nfswolf no
> longer detects NLM registration in the portmapper, runs NLM lock storms,
> or exposes any NLM/NSM protocol surface. This write-up is preserved for
> reference; no nfswolf subcommand exercises F-6.1.
