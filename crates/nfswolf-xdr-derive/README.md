...
The traits themselves live in [`nfswolf-xdr`](../nfswolf-xdr); this crate only exists because Rust requires proc macros to ship in their own crate.
...
Derived from [Vaiz/nfs3](https://github.com/Vaiz/nfs3) (Unlicense / public domain). See [`../nfswolf-xdr/NOTICE`](../nfswolf-xdr/NOTICE).
