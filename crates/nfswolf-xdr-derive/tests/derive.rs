...
// indirectly through nfswolf_xdr's re-export of the derive macro.
...
fn round_trip_named_struct() {
    ...
    #[derive(nfswolf_xdr::XdrCodec, Debug, PartialEq)]
    struct Point {
        x: u32,
        y: u32,
    }
...
fn round_trip_simple_enum() {
    ...
    #[derive(nfswolf_xdr::XdrCodec, Debug, PartialEq, Clone, Copy)]
    #[repr(u32)]
    enum Color {
        Red = 0,
        Green = 1,
