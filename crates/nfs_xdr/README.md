...
The traits themselves live in [`nfs_proto::xdr`](../nfs_proto); this crate only exists because Rust requires proc macros to ship in their own crate.
...
Types whose wire form breaks the mechanical rule -- NFSv2's fixed-width 32-byte file handles, the RPC reply body's nested unions -- implement the traits by hand in `nfs_proto` instead.

## Provenance

Derived from [Vaiz/nfs3](https://github.com/Vaiz/nfs3) (Unlicense / public domain). See [`../nfs_proto/NOTICE`](../nfs_proto/NOTICE).
