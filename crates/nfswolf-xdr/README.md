...
Most wire types get their implementations from `#[derive(XdrCodec)]`, re-exported here from [`nfswolf-xdr-derive`](../nfswolf-xdr-derive). Types whose encoding breaks the mechanical field-by-field rule implement the traits by hand.
