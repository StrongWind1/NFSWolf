...
| [F-4.2: SUID/SGID Escalation](F-4.2-suid-sgid-escalation.md) | SUID binaries set to execute-only are readable, enabling offline analysis |
| [F-1.1: UID/GID Spoofing](F-1.1-uid-gid-spoofing.md) | Spoofed credentials may grant execute permission needed to trigger the fallback |
